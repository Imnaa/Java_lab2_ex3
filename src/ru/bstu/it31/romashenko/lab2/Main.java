 ...
 *
 * Имя класса: Main
 * Описание:    Начав тренировки, спортсмен в первый день пробежал n км. Каждый
 *              день он увеличивал дневную норму на m% нормы предыдущего дня.
 *              Какой суммарный путь пробежит спортсмен за k дней?
 */
public class Main {
    /** */
